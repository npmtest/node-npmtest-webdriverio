...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/orientation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/orientation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/</a> &#187; orientation.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
var orientation = <span class="fstat-no" title="function not covered" >function orientation(deviceOrientation) {</span>
<span class="cstat-no" title="statement not covered" >    var data = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof deviceOrientation === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        data.orientation = deviceOrientation.toUpperCase();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.requestHandler.create('/session/:sessionId/orientation', data);</span>
};
&nbsp;
