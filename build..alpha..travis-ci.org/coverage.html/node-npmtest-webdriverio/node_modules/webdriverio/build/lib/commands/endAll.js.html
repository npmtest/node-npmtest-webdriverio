...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/endAll.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/endAll.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/</a> &#187; endAll.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
var endAll = <span class="fstat-no" title="function not covered" >function endAll() {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.sessions().then(<span class="fstat-no" title="function not covered" >function (res) {</span></span>
<span class="cstat-no" title="statement not covered" >        var sessionCommands = [];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                var session = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                sessionCommands.push(_this.session('delete', session.id));</span>
            }
        } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _this.unify(sessionCommands);</span>
    });
};
&nbsp;
