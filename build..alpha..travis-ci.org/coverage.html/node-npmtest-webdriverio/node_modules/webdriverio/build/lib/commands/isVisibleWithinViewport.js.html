...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/isVisibleWithinViewport.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/isVisibleWithinViewport.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/</a> &#187; isVisibleWithinViewport.js</div>
</div>
<div class="body">
...
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function isVisibleWithinViewport(selector) {</span>
<span class="cstat-no" title="statement not covered" >    return this.selectorExecute(selector, _isWithinViewport2.default).then(<span class="fstat-no" title="function not covered" >function (res) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (Array.isArray(res) &amp;&amp; res.length === 1) {</span>
...
<span class="cstat-no" title="statement not covered" >        return res;</span>
         ...
         */
<span class="cstat-no" title="statement not covered" >        if (err.message.indexOf('NoSuchElement') &gt; -1) {</span>
