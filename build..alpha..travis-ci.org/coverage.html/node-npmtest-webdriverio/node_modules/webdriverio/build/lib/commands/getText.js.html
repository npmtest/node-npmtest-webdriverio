...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/getText.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/getText.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/</a> &#187; getText.js</div>
</div>
<div class="body">
...
&nbsp;
var getText = <span class="fstat-no" title="function not covered" >function getText(selector) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var elementIdTextCommands = [];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                elementIdTextCommands.push(_this.elementIdText(elem.ELEMENT));</span>
            }
        } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _this.unify(elementIdTextCommands, {</span>
            extractValue: true
        });
    });
}; /**
