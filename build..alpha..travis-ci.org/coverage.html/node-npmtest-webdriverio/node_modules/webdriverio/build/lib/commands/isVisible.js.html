...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/isVisible.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/isVisible.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/commands/</a> &#187; isVisible.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
var isVisible = <span class="fstat-no" title="function not covered" >function isVisible(selector) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var elementIdDisplayedCommands = [];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                elementIdDisplayedCommands.push(_this.elementIdDisplayed(elem.ELEMENT));</span>
            }
        } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return _this.unify(elementIdDisplayedCommands, {</span>
            extractValue: true
        });
    });
};
