...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/executeAsync.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/executeAsync.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/</a> &#187; executeAsync.js</div>
</div>
<div class="body">
...
&nbsp;
var executeAsync = <span class="fstat-no" title="function not covered" >function executeAsync() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var script = args.shift();</span>
&nbsp;
    /*!
     * parameter check
     */
<span class="cstat-no" title="statement not covered" >    if (typeof script !== 'string' &amp;&amp; typeof script !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >        throw new _ErrorHandler.ProtocolError('number or type of arguments don\'t agree with execute protocol command');</span>
    }
&nbsp;
    /*!
     ...
     */
<span class="cstat-no" title="statement not covered" >    if (typeof script === 'function' || this.inMultibrowserMode &amp;&amp; script.indexOf('function (') === 0) {</span>
...
<span class="cstat-no" title="statement not covered" >    return this.requestHandler.create('/session/:sessionId/execute_async', {</span>
        script: script,
        args: args
    });
}; /**
