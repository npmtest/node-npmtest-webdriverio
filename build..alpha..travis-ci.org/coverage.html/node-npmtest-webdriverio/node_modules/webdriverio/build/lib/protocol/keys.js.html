...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/keys.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/keys.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/lib/protocol/</a> &#187; keys.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function keys(value) {</span>
...
<span class="cstat-no" title="statement not covered" >        throw new _ErrorHandler.ProtocolError('number or type of arguments don\'t agree with keys protocol command');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.requestHandler.create('/session/:sessionId/keys', {</span>
        'value': key
    });
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return _constants.UNICODE_CHARACTERS.hasOwnProperty(value) ? [_constants.UNICODE_CHARACTERS[value]] : value.split('');</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
