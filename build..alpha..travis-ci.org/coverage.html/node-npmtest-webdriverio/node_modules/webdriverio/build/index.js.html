...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-webdriverio/node_modules/webdriverio/build/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-webdriverio/node_modules/webdriverio/build/index.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">43.75% <small>(28 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-webdriverio/node_modules/webdriverio/build/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
var remote = <span class="fstat-no" title="function not covered" >function remote() {</span>
<span class="cstat-no" title="statement not covered" >    var options = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : {};</span>
<span class="cstat-no" title="statement not covered" >    var modifier = arguments[1];</span>
&nbsp;
    /**
     * initialise monad
     */
<span class="cstat-no" title="statement not covered" >    var wdio = (0, _webdriverio2.default)(options, modifier);</span>
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >        for (var _iterator = (0, _getIterator3.default)((0, _keys2.default)(IMPLEMENTED_COMMANDS)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {</span>
<span class="cstat-no" title="statement not covered" >            var commandName = _step.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            wdio.lift(commandName, IMPLEMENTED_COMMANDS[commandName]);</span>
        }
    } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var prototype = wdio();</span>
<span class="cstat-no" title="statement not covered" >    prototype.defer.resolve();</span>
<span class="cstat-no" title="statement not covered" >    return prototype;</span>
};
&nbsp;
var multiremote = <span class="fstat-no" title="function not covered" >function multiremote(options) {</span>
<span class="cstat-no" title="statement not covered" >    var multibrowser = new _multibrowser2.default();</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        for (var _iterator2 = (0, _getIterator3.default)((0, _keys2.default)(options)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {</span>
<span class="cstat-no" title="statement not covered" >            var browserName = _step2.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            multibrowser.addInstance(browserName, remote(options[browserName], multibrowser.getInstanceModifier()));</span>
        }
    } catch (err) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return remote(options, multibrowser.getModifier());</span>
};
&nbsp;
